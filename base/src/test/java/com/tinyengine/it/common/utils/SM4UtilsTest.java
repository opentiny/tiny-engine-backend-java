...
class SM4UtilsTest {
    ...
    void encryptAndDecryptRoundTrip() throws GeneralSecurityException {
        ...
        assertTrue(encrypted.startsWith("GCM1:"));
        assertEquals(
                "secret-api-key",
    ...
    void decryptsLegacyEcbPayload() throws GeneralSecurityException {
        ...
        assertEquals("legacy-api-key", SM4Utils.decrypt(legacyPayload, key));
    }
    ...
    void decryptsUnversionedGcmPayload() throws GeneralSecurityException {
        ...
        final String unversionedPayload = versionedPayload.substring("GCM1:".length());

        assertEquals("unversioned-gcm", SM4Utils.decrypt(unversionedPayload, key));
    }
