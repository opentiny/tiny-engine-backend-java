...
public class BusinessCategoryServiceImpl implements BusinessCategoryService {
    ...
    */
    @Override
    public List<BusinessCategory> findAllBusinessCategory() throws ServiceException {
        return businessCategoryMapper.findAllBusinessCategory();
    }
    ...
    */
    @Override
    public BusinessCategory findBusinessCategoryById(@Param("id") Integer id) throws ServiceException {
        return businessCategoryMapper.findBusinessCategoryById(id);
    }
    ...
    */
    @Override
    public List<BusinessCategory> findBusinessCategoryByCondition(BusinessCategory businessCategory) throws ServiceException {
        return businessCategoryMapper.findBusinessCategoryByCondition(businessCategory);
    }
