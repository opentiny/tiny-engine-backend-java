...
public class PageTemplateServiceImpl implements PageTemplateService {
    ...
    */
    @Override
    public List<PageTemplate> findAllPageTemplate() throws ServiceException {
        return pageTemplateMapper.findAllPageTemplate();
    }
    ...
    */
    @Override
    public PageTemplate findPageTemplateById(@Param("id") Integer id) throws ServiceException {
        return pageTemplateMapper.findPageTemplateById(id);
    }
    ...
    */
    @Override
    public List<PageTemplate> findPageTemplateByCondition(PageTemplate pageTemplate) throws ServiceException {
        return pageTemplateMapper.findPageTemplateByCondition(pageTemplate);
    }
