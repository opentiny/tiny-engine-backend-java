...
public class I18nEntryController {
    ...
    public Result<List<I18nEntry>> batchCreateEntries(@Valid @RequestBody OperateI18nBatchEntries operateI18nBatchEntries) {
    ...
    public Result<List<I18nEntry>> deleteI18nEntries(@RequestBody DeleteI18nEntry iDeleteI18nEntry) throws ServiceException {
        ...
        List<I18nEntry> i18nEntriesList = i18nEntryService.deleteI18nEntriesByHostAndHostTypeAndKey(host, hostType, keys);
        return Result.success(i18nEntriesList);
    }
