...
create table t_platform (
    ...
    primary key (id),
    unique index u_idx_platform (tenant_id, name)
  ) comment = '设计器表';
...
create table t_platform_history (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_platform_history (ref_id, version)
  ) comment = '设计器历史表';
...
create table t_app (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_app (tenant_id, platform_id, name)
  ) comment = '应用表';
...
create table t_app_extension (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_app_extension (app_id, name)
  ) comment = '应用扩展表';
...
create table t_block_group (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_block_group (tenant_id, platform_id, name)
  ) comment = '区块分组表，设计器内共享';
...
create table t_business_category (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_business_category (tenant_id, code)
  ) comment = '业务类型表，全局';
...
create table t_block (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_block (platform_id, label, framework)
  ) comment = '区块表';
...
create table t_block_history (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_block_history (app_id, ref_id, version)
  ) comment = '区块历史表';
...
create table t_material (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_material (tenant_id, name, framework)
  ) comment = '物料包表';
...
create table t_material_history (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_material_history (tenant_id, ref_id, version)
  ) comment = '物料包历史表';
...
create table t_page (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_page (app_id, name)
  ) comment = '页面表';
...
create table t_pages_history (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_page_history (app_id, ref_id, version)
  ) comment = '页面历史表';
...
create table t_component (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_component (tenant_id, name, version)
  ) comment = '组件表';
...
create table t_i18n_entry (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_i18n_entity (tenant_id, "key", lang_id)
  ) comment = '国际化语言配置表';
...
create table t_i18n_lang (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_18n_lang (lang)
  ) comment = '国际化语言表，全局';
...
create table t_datasource (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_datasource (tenant_id, platform_id, name)
  ) comment = '数据源表';
...
create table t_tenant (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_tenant (name_cn)
  ) comment = '租户表';
...
create table t_user (
    ...
    last_updated_time timestamp not null default current_timestamp comment '更新时间',
    primary key (id),
    unique index u_idx_user (username)
  ) comment = '用户表';