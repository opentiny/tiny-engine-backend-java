...
ALTER TABLE t_app ADD COLUMN industry_id INT AFTER platform_id;
ALTER TABLE t_app ADD COLUMN scene_id INT AFTER industry_id;
...
ALTER TABLE t_app_extension ADD COLUMN platform_id INT AFTER app_id;
ALTER TABLE t_app_extension DROP INDEX u_idx_app_extension;
ALTER TABLE t_app_extension ADD INDEX u_idx_app_extension (`tenant_id`, `platform_id`, `name`, `app_id`);
